...
/*
PresenceApiService Get this user's presence state.
Get the given user&#39;s presence state.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId The user whose presence state to get.
@return InlineResponse20022
*/
func (a *PresenceApiService) GetPresence(ctx context.Context, userId string) (InlineResponse20022, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/_matrix/client/unstable/presence/{userId}/status"
...
/*
PresenceApiService Update this user's presence state.
...
*/
func (a *PresenceApiService) SetPresence(ctx context.Context, userId string, presenceState InlineObject15) (map[string]interface{}, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &presenceState
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
